	...
	SET NOCOUNT ON;
		...
		if (@INSERTCOUNT >0 AND @DELETEDCOUNT > 0)
			BEGIN
				...
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U', @DELETEDCOVERPAGENO, @INSERTEDCOVERPAGENO, 'Updated ' + ' cover seal from ' + @DELETEDCOVERPAGENO + ' to ' + @INSERTEDCOVERPAGENO, 'UF200694');
				END
				if (@INSERTEDMETROID != @DELETEDMETROID)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U',  @DELETEDMETROID, @INSERTEDMETROID, 'Updated ' + @DELETEDCOVERPAGENO + ' and ' + @DELETEDMETROID + ' seal-METRO pair METRO id from ' + @DELETEDMETROID + ' to ' + @INSERTEDMETROID, 'UF200694');
				END
				if (@INSERTEDREMARK  != @DELETEDREMARK)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U', @DELETEDREMARK, @INSERTEDREMARK, 'Updated ' + @INSERTEDCOVERPAGENO + ' and ' + @INSERTEDMETROID + ' seal-METRO pair remark from ' + @DELETEDREMARK + ' to ' + @INSERTEDREMARK, 'UF200694');
				END
				if (@INSERTEDDATEPAIRED != @DELETEDDATEPAIRED)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U',@DELETEDDATEPAIRED, @INSERTEDDATEPAIRED, 'Updated ' + @INSERTEDCOVERPAGENO + ' and ' + @INSERTEDMETROID + ' seal-METRO pair date created from ' + @DELETEDDATEPAIRED + ' to ' + @INSERTEDDATEPAIRED, 'UF200694');
				END
				if (@INSERTEDPAIREDBY != @DELETEDPAIREDBY)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U', @DELETEDPAIREDBY, @INSERTEDPAIREDBY, 'Updated ' + @INSERTEDCOVERPAGENO + ' and ' + @INSERTEDMETROID + ' seal-METRO pair date calibrated from ' + @DELETEDPAIREDBY + ' to ' + @INSERTEDPAIREDBY, 'UF200694');
				END
				if (@INSERTEDDATECALIBRATED != @DELETEDDATECALIBRATED)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'U', @DELETEDDATECALIBRATED , @INSERTEDDATECALIBRATED, 'Updated ' + @INSERTEDCOVERPAGENO + ' and ' + @INSERTEDMETROID + ' seal-METRO pair date calibrated from ' + @DELETEDDATECALIBRATED  + ' to ' + @INSERTEDDATECALIBRATED, 'UF200694');
				END
			END
		else 
			if (@INSERTCOUNT >0 AND @DELETEDCOUNT=0)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'I', null, @INSERTEDCOVERPAGENO + ', ' + @INSERTEDMETROID, 'Inserted ' + @INSERTEDCOVERPAGENO + ' and ' + @INSERTEDMETROID + ' seal-METRO pair', 'UF200694');		
				END
			else 
			if (@INSERTCOUNT=0 AND @DELETEDCOUNT > 0)
			BEGIN
				INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_SEAL_METRO_PAIR', 'D', @DELETEDCOVERPAGENO + ', ' + @DELETEDMETROID, null, 'Deleted ' + @DELETEDCOVERPAGENO  + ' and ' + @DELETEDMETROID  + ' seal-METRO pair', 'UF200694');
			END
END
