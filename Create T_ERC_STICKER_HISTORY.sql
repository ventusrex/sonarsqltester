		...
		if (@INSERTCOUNT >0 AND @DELETEDCOUNT > 0)
			BEGIN
				...
				BEGIN
					...
					VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'U', @DELETEDSTICKERNO, @INSERTEDSTICKERNO , 'Updated ' + ' erc sticker number from ' + @DELETEDSTICKERNO + ' to ' + @INSERTEDSTICKERNO, 'UF200694');
				END
				if (@INSERTEDREMARK != @DELETEDREMARK)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'U', @DELETEDREMARK, @INSERTEDREMARK, 'Updated ' +@INSERTEDSTICKERNO+ ' remark from ' + @DELETEDREMARK + ' to ' + @INSERTEDREMARK, 'UF200694');
				END
				if (@INSERTEDREPLICATECOUNT  != @DELETEDREPLICATECOUNT)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'U', @DELETEDREPLICATECOUNT, @INSERTEDREPLICATECOUNT, 'Updated ' +@INSERTEDSTICKERNO+ ' replicate count from ' + @DELETEDREPLICATECOUNT + ' to ' + @INSERTEDREPLICATECOUNT, 'UF200694');
				END
				if (@INSERTEDDATETAGGED != @DELETEDDATETAGGED)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'U', @DELETEDDATETAGGED, @INSERTEDDATETAGGED, 'Updated ' +@INSERTEDSTICKERNO+ ' date tagged from ' + @DELETEDDATETAGGED + ' to ' + @INSERTEDDATETAGGED, 'UF200694');
				END
				if (@INSERTEDTAGGEDBY != @DELETEDTAGGEDBY)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'U', @DELETEDTAGGEDBY, @INSERTEDTAGGEDBY, 'Updated ' +@INSERTEDSTICKERNO+ ' tagged by from ' + @DELETEDTAGGEDBY + ' to ' + @INSERTEDTAGGEDBY, 'UF200694');
				END
			END
		else 
			if (@INSERTCOUNT >0 AND @DELETEDCOUNT=0)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'I', null, @INSERTEDSTICKERNO, 'Inserted ' + @INSERTEDSTICKERNO, 'UF200694');		
				END
			else 
			if (@INSERTCOUNT=0 AND @DELETEDCOUNT > 0)
			BEGIN
				INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_STICKER', 'D', @DELETEDSTICKERNO, null, 'Deleted ' + @DELETEDSTICKERNO, 'UF200694');
			END
END
