		...
		if (@INSERTCOUNT >0 AND @DELETEDCOUNT > 0)
			BEGIN
				...
				BEGIN
					...
					VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'U', @DELETEDBASEPLATE, @INSERTEDBASEPLATE , 'Updated ' +  @DELETEDMETROID + ' baseplate from ' + @DELETEDBASEPLATE + ' to ' + @INSERTEDBASEPLATE, 'UF200694');
				END
				if (@INSERTEDNAMEPLATE != @DELETEDNAMEPLATE)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) 
					VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'U', @DELETEDNAMEPLATE, @INSERTEDNAMEPLATE , 'Updated ' +  @DELETEDMETROID + ' nameplate from ' + @DELETEDNAMEPLATE + ' to ' + @INSERTEDNAMEPLATE, 'UF200694');				
				END
				if (@INSERTEDREGISTER  != @DELETEDREGISTER)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) 
					VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'U', @DELETEDREGISTER, @INSERTEDREGISTER , 'Updated ' +  @DELETEDMETROID + ' register from ' + @DELETEDREGISTER + ' to ' + @INSERTEDREGISTER, 'UF200694');				
				END
				if (@INSERTEDDATECREATED != @DELETEDDATECREATED)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) 
					VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'U', @DELETEDDATECREATED, @INSERTEDDATECREATED , 'Updated ' +  @DELETEDMETROID + ' date created from ' + @DELETEDDATECREATED + ' to ' + @INSERTEDDATECREATED, 'UF200694');				
				END
				if (@INSERTEDDATECALIBRATED != @DELETEDDATECALIBRATED)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) 
					VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'U', @DELETEDDATECALIBRATED, @INSERTEDDATECALIBRATED , 'Updated ' +  @DELETEDMETROID + ' date calibrated from ' + @DELETEDDATECALIBRATED + ' to ' + @INSERTEDDATECALIBRATED, 'UF200694');				
				END
			END
		else 
			if (@INSERTCOUNT >0 AND @DELETEDCOUNT=0)
				BEGIN
					INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'I', null, @INSERTEDMETROID, 'Inserted ' + @INSERTEDMETROID, 'UF200694');		
				END
			else 
			if (@INSERTCOUNT=0 AND @DELETEDCOUNT > 0)
			BEGIN
				INSERT INTO BBCT.T_HISTORY (DATE_DONE, TABLE_NAME, ACTIVITY, DATA_FROM, DATA_TO, DESCRIPTION, USERNAME) VALUES (CURRENT_TIMESTAMP, 'T_METRO', 'D', @DELETEDMETROID, null, 'Deleted ' + @DELETEDMETROID, 'UF200694');
			END
END